...
def build() -> SimulationRunner:
    ...
    robot_states = {
        RobotId(1): RobotState(robot_id=RobotId(1), position=Position(_START.x, _START.y - 1)),
        RobotId(2): RobotState(robot_id=RobotId(2), position=Position(_START.x, _START.y + 1)),
    }
